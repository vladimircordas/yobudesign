...
@Component({
  selector: 'app-gallerysculptures',
  templateUrl: './gallerysculptures.component.html',
  styleUrls: ['./gallerysculptures.component.scss']
})
export class GallerysculpturesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.galleryOptions = [
      ...
      },{ "breakpoint": 600, "width": "95%", "height": "800px", "thumbnailsColumns": 2, "thumbnailsRows": 5, }
      ,{ "breakpoint": 450, "width": "95%", "height": "600px", "thumbnailsColumns": 1, "thumbnailsRows": 3, }
    ];
