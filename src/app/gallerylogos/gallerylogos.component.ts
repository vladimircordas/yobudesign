...
@Component({
  selector: 'app-gallerylogos',
  templateUrl: './gallerylogos.component.html',
  styleUrls: ['./gallerylogos.component.scss']
})
export class GallerylogosComponent implements OnInit {
