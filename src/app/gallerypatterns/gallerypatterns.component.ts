...
@Component({
  selector: 'app-gallerypatterns',
  templateUrl: './gallerypatterns.component.html',
  styleUrls: ['./gallerypatterns.component.scss']
})
export class GallerypatternsComponent implements OnInit {
