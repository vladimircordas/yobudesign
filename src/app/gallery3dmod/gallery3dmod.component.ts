...
@Component({
  selector: 'app-gallery3dmod',
  templateUrl: './gallery3dmod.component.html',
  styleUrls: ['./gallery3dmod.component.scss']
})
export class Gallery3dmodComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.galleryOptions = [
      ...
      ,{ "breakpoint": 400, "width": "95%", "height": "600px", "thumbnailsColumns": 1, "thumbnailsRows": 3, }
    ];
