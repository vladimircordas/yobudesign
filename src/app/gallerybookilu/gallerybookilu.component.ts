...
@Component({
  selector: 'app-gallerybookilu',
  templateUrl: './gallerybookilu.component.html',
  styleUrls: ['./gallerybookilu.component.scss']
})
export class GallerybookiluComponent implements OnInit {
