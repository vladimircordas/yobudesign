...
@Component({
  selector: 'app-gallerydigitalp',
  templateUrl: './gallerydigitalp.component.html',
  styleUrls: ['./gallerydigitalp.component.scss']
})
export class GallerydigitalpComponent implements OnInit {
